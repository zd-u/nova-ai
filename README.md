...
2. 选择你想使用的模型平台（如 DeepSeek、OpenAI 等）
3. 填入对应平台的 API Key
4. 点击保存配置
5. 重新打开 Chat 页面即可开始聊天
...
| **Google Gemini** | `gemini-2.5-flash` | `https://generativelanguage.googleapis.com/v1beta/openai/` | [https://aistudio.google.com/apikey](https://aistudio.google.com/apikey) |
...
编辑 `server/_core/index.ts` 中的 System Prompt，修改 Nova 的性格和行为。
